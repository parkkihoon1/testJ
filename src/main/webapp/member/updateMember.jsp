...
<head>
    ...
    <sql:setDataSource var="dataSource"
                       url="jdbc:mariadb://localhost:3306/teamproject_market"
                       driver="org.mariadb.jdbc.Driver"
                       user="root" password="8259"/>
...
<c:forEach var="row" items="${resultSet.rows }">
    ...
    <form class="formWrap" action="processUpdateMember.jsp"
        ...
        <div class="row mb-3">
            <%--@declare id="password_confirm"--%><label for="password_confirm" class="col-sm-3 col-form-label">비밀번호 확인</label>
            <div class="col-sm-5">
        ...
        <div class="row mb-3">
            <%--@declare id="birth"--%><label for="birth" class="col-sm-3 col-form-label">생년월일</label>
        ...
        <div class="row mb-3">
            <%--@declare id="mail"--%><label for="mail" class="col-sm-3 col-form-label">이메일</label>
        ...
        <div class="row mb-3">
            <%--@declare id="phone"--%><label for="phone" class="col-sm-3 col-form-label">휴대폰 번호</label>
        ...
        <div class="row mb-3">
            <%--@declare id="interest"--%><label for="interest" class="col-sm-3 col-form-label">동의 여부</label>
            <div class="col-sm-8">
