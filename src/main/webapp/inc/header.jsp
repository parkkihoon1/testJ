...
<div class="container">
    <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-between py-3 mb-1 border-bottom">
        <a href="../main/welcome.jsp" class="d-flex align-items-center mb-2 mb-md-0 text-dark text-decoration-none">
        ...
        <ul class="nav my-2 justify-content-center my-md-0 text-small">
            <li><a href="../main/welcome.jsp" class="nav-link text-black"> Home </a></li>
            ...
            <li><a href="../board/BoardListAction.do?pageNum=1" class="nav-link text-muted"> 게시판 </a></li>
